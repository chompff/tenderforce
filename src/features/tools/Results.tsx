...
import { ArrowLeft, Info, ChevronDown, ChevronUp, Lock, Star, CheckCircle, Building, Calculator } from 'lucide-react';
        ...
        <Collapsible open={isOpen} onOpenChange={setIsOpen}>
          <CollapsibleTrigger asChild>
            <button className="flex items-center gap-1 text-blue-600 text-sm hover:text-blue-800 transition-colors">
              {isOpen ? 'Minder informatie' : 'Meer informatie'}
...
const Results: React.FC = () => {
  ...
  const sampleBepalingScope = [
    {
      ...
      level: "basis",
      description: "Duidelijke omschrijving van de gewenste prestatie en resultaten",
    ...
    {
      title: "Budgetbepaling en financiële kaders",
      level: "gemiddeld",
      description: "Vaststellen van het beschikbare budget en financiële voorwaarden",
  ...
  const sampleGunningscriteria = [
    {
      title: "Duurzaamheidscore",
      level: "basis",
      description: "Minimaal 70% duurzaamheidscore vereist voor alle producten",
      expandedInfo: "Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur."
    }
  ];
            ...
            >
              ...
              <AccordionItem value="gunningscriteria" className="bg-white rounded-xl shadow-sm border">
                ...
                <AccordionContent className="px-6 pb-6">
                  <div className="space-y-4">
                    <div className="text-gray-600 mb-4">
                      <p className="mb-4">Gunningscriteria bepalen op basis van welke factoren je de beste inschrijving selecteert. Het meest economisch voordelige aanbod is de standaard, waarbij je kijkt naar de beste prijs-kwaliteitverhouding.</p>
                      <p>Naast prijs kun je kijken naar kwaliteit, duurzaamheid, sociale aspecten, innovatie en andere factoren die relevant zijn voor je opdracht. Geef elk criterium een duidelijke weging en omschrijving.</p>
                    </div>
