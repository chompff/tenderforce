...
const WezenlijkeWijzigingscheckHero: React.FC = () => {
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Wezenlijke <span className="text-blue-600">wijzigingscheck</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Is er sprake van een wezenlijke wijziging?<br />
...
export default WezenlijkeWijzigingscheckHero; 