...
const GemengdeOpdrachtHero: React.FC = () => {
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              <span className="text-blue-600">Gemengde opdracht kwalificatie</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Check het drempelbedrag van jouw gemengde opdracht.<br />
            ...
            <div className="mb-8">
              <Autocomplete 
                ref={autocompleteRef}
                placeholder="Bijv. meubilair met installatie, software met support..."
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              <button 
                onClick={() => handlePillClick('Meubilair met installatie')}
                className="text-sm bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition-colors"
              >
                Meubilair met installatie
              </button>
              <button 
                onClick={() => handlePillClick('Software met support')}
                className="text-sm bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 transition-colors"
              >
                Software met support
              </button>
            </div>
          </div>
        </div>
...
export default GemengdeOpdrachtHero; 