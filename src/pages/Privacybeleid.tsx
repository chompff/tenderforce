          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-3">2.1 Accountgegevens</h3>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  ...
                  <li><strong>Communicatie:</strong> Productupgrades en belangrijke mededelingen</li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Gegevens delen</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  <li><strong>Toegang:</strong> Inzicht in welke gegevens wij van u hebben</li>
                  <li><strong>Rectificatie:</strong> Correctie van onjuiste gegevens</li>
                  <li><strong>Wissing:</strong> Verwijdering van uw gegevens</li>
                  <li><strong>Beperking:</strong> Beperking van gegevensverwerking</li>
                  <li><strong>Overdraagbaarheid:</strong> Export van uw gegevens</li>
                  <li><strong>Bezwaar:</strong> Bezwaar tegen bepaalde verwerkingen</li>
                  <li><strong>Klacht:</strong> Klacht indienen bij de Autoriteit Persoonsgegevens</li>
                </ul>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Gegevensbeveiliging</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Wij implementeren industry-standaard beveiligingsmaatregelen:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  <li>End-to-end encryptie voor alle datatransmissies</li>
                  <li>Multi-factor authenticatie voor accounts</li>
                  <li>Regelmatige beveiligingsaudits en penetratietests</li>
                  <li>Gegevensbackups in Nederlandse/EU datacenters</li>
                  <li>24/7 beveiligingsmonitoring</li>
                </ul>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Gegevensretentie</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Wij bewaren uw gegevens zolang nodig voor:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Wij kunnen dit privacybeleid periodiek bijwerken. Belangrijke wijzigingen worden 30 dagen van tevoren 
                  gecommuniceerd via e-mail. Continued gebruik van onze diensten na wijzigingen betekent acceptatie van 
